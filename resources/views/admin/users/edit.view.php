            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5><strong>Editar Usuario: {{ $usuario['us_shortname'] }}</strong></h5>
                        <div>
                    ...
                    <div class="card-body">
                        <form id="formulario" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_titulo" id="us_titulo"
                                        value="{{ $usuario['us_titulo'] }}" placeholder="Abreviatura del Título e.g. Lic."
                                        required autofocus>
                                    <div id="error-us_titulo" class="invalid-feedback" style="display:none;"></div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="us_titulo_descripcion" class="col-sm-2 col-form-label">Descripción del
                                    Título:</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="us_titulo_descripcion" id="us_titulo_descripcion" rows="2"
                                        placeholder="Descripción del Título e.g. Licenciado en Ciencias de la Educación">{{ $usuario['us_titulo_descripcion'] }}</textarea>
                                    <div id="error-us_titulo_descripcion" class="invalid-feedback" style="display:none;">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_apellidos" id="us_apellidos"
                                        value="{{ $usuario['us_apellidos'] }}" required>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_nombres" id="us_nombres"
                                        value="{{ $usuario['us_nombres'] }}" required>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_shortname" id="us_shortname"
                                        value="{{ $usuario['us_shortname'] }}" required>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_fullname" id="us_fullname"
                                        value="{{ $usuario['us_fullname'] }}" disabled>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="us_login" id="us_login"
                                        value="{{ $usuario['us_login'] }}" required>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <select name="us_genero" id="us_genero" class="form-control">
                                        <option value="F" {{ $usuario['us_genero'] == 'F' ? 'selected' : '' }}>
                                            Femenino</option>
                                        <option value="M" {{ $usuario['us_genero'] == 'M' ? 'selected' : '' }}>
                                            Masculino</option>
                                    </select>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <select name="us_activo" id="us_activo" class="form-control">
                                        <option value="1" {{ $usuario['us_activo'] == '1' ? 'selected' : '' }}>Sí
                                        </option>
                                        <option value="0" {{ $usuario['us_activo'] == '0' ? 'selected' : '' }}>No
                                        </option>
                                    </select>
                            ...
                            <div id="perfiles-container" class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div id="error-perfiles" class="text-danger mt-1"
                            ...
                            <div class="row mb-2">
                                ...
                                <div id="img_div" class="col-sm-10">
                                    <img id="us_avatar" src="{{ $avatarUrl }}" name="us_avatar"
                                        class="img-thumbnail" width="75" alt="Avatar del usuario">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <label for="us_foto" class="col-sm-2 control-label"
