<div class="container-fluid px-4">
    <div class="card mt-2 mb-4">
        <div class="card-header">
            ...
            Editar Categoría de Especialidad
        </div>
        <div class="card-body">
            <form id="formulario" action="" method="post">
                <input type="hidden" name="id_categoria" value="<?= $datos['categoria']->id_categoria ?>">
                <div class="mb-3">
                    <label for="nombre" class="form-label requerido">Nombre:</label>
                    <input type="text" class="form-control" value="<?= $datos['categoria']->nombre ?>" name="nombre" id="nombre" required>
