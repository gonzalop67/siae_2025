    ...
    <div class="card mt-2 mb-4">
        ...
        <div class="card-body">
            ...
            <form id="formulario" action="" method="post">
                ...
                <div class="mb-3">
                    <label for="nombre" class="form-label requerido">Categoría:</label>
                    <select class="form-select" name="categoria" id="categoria" required>
                        <option value="">Seleccione...</option>
                        <?php
                        foreach ($datos['categorias'] as $categoria) {
                        ?>
                            <option value="<?= $categoria->id_categoria ?>" <?= $categoria->id_categoria == $datos['especialidad']->id_categoria ? 'selected' : '' ?>><?= $categoria->nombre ?></option>
                        <?php
                        }
                        ?>
                    </select>
