        ...
        <div class="card-body">
            <form id="formulario" action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <p id="error-tipos_aporte" class="invalid-feedback">Debes seleccionar un tipo de aporte de evaluación...</p>
                </div>
                <div class="mb-2">
                ...
                <!-- <div class="mb-2">
                    <label for="ponderacion" class="form-label form-control-sm requerido">Ponderación:</label>
                    <input name="ponderacion" id="ponderacion" type="number" min="0.1" max="1" step="0.01" class="form-control form-control-sm" value="" required>
                    <p id="error-ponderacion" class="invalid-feedback">La ponderación del aporte de evaluación debe estar en el rango de 0.1 a 1.</p>
                </div> -->
                <div class="mb-2">
