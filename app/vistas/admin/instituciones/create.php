<div class="container-fluid px-4">
    <div class="card mb-4 mt-2">
        ...
        <div class="card-body">
            ...
            <form id="formulario" action="<?= RUTA_URL . "instituciones/store/" ?>" enctype="multipart/form-data" method="post">
                <div class="row mb-2">
                    <div class="col-12">
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <label for="direccion" class="form-label requerido">Dirección:</label>
                        <input type="text" class="form-control" value="" name="direccion" id="direccion" required>
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <label for="email" class="form-label requerido">Email:</label>
                ...
                <div id="administrador" class="row mb-3">
                    <div class="col-12">
                        <label class="form-label requerido">Administrador</label>
                        <div id="img_admin" class="d-none">
                            <img id="avatar_admin" name="avatar_admin" class="img-thumbnail" width="75">
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <select class="form-select" id="admin_id" name="admin_id">
                            ...
                            ?>
                                <option value="<?= $datos['admin_list'][$i]->id_usuario ?>"><?= $datos['admin_list'][$i]->us_shortname ?></option>
                            <?php
                            }
                            ?>
                        </select>
                ...
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="telefono" class="form-label requerido">Teléfono:</label>
                        <input type="text" class="form-control" value="" name="telefono" id="telefono" required>
                        <p id="error-telefono" class="invalid-feedback">El campo Teléfono es obligatorio.</p>
                    </div>
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="regimen" class="form-label requerido">Régimen:</label>
                        <input type="text" class="form-control text-uppercase" value="" name="regimen" id="regimen" required>
                        <p id="error-regimen" class="invalid-feedback">El campo Régimen debe contener de 4 a 16 caracteres alfabéticos.</p>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="rector" class="form-label requerido">Rector:</label>
                        <input type="text" class="form-control" value="" name="rector" id="rector" required>
                        <p id="error-rector" class="invalid-feedback">El nombre del Rector debe contener de 4 a 64 caracteres alfabéticos.</p>
                    </div>
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="rector_genero" class="form-label requerido">Género:</label>
                ...
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="vicerrector" class="form-label requerido">Vicerrector:</label>
                        <input type="text" class="form-control" value="" name="vicerrector" id="vicerrector" required>
                        <p id="error-vicerrector" class="invalid-feedback">El nombre del Vicerrector debe contener de 4 a 64 caracteres alfabéticos.</p>
                    </div>
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="vicerrector_genero" class="form-label requerido">Género:</label>
                ...
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="secretario" class="form-label requerido">Secretario:</label>
                        <input type="text" class="form-control" value="" name="secretario" id="secretario" required>
                        <p id="error-secretario" class="invalid-feedback">El nombre del Secretario debe contener de 4 a 64 caracteres alfabéticos.</p>
                    </div>
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="secretario_genero" class="form-label requerido">Género:</label>
                ...
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="url" class="form-label requerido">URL:</label>
                        <input type="text" class="form-control" value="" name="url" id="url" required>
                        <p id="error-url" class="invalid-feedback">El campo URL debe contener una dirección URL válida</p>
                    </div>
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="amie" class="form-label requerido">AMIE:</label>
                        <input type="text" class="form-control text-uppercase" value="" name="amie" id="amie" required>
                        <p id="error-amie" class="invalid-feedback">El campo AMIE debe contener un código AMIE válido</p>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-6 col-sm-12 col-md-6">
                        <label for="ciudad" class="form-label requerido">Ciudad:</label>
                        <input type="text" class="form-control" value="" name="ciudad" id="ciudad" required>
                    ...
                    <div class="col-6 col-sm-12 col-md-6">
                        ...
                        <input type="checkbox" id="copiar_y_pegar" name="copiar_y_pegar">
                    </div>
                </div>
                <div id="img_upload">
                    <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button id="btn-submit" type="submit" class="btn btn-primary">Insertar los datos de la institución</button>
                </div>
            </form>
        </div>
    </div>
