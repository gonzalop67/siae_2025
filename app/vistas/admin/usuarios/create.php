    ...
    <div class="card mt-2 mb-4">
        ...
        <div class="card-body">
            ...
            <form id="formulario" action="" enctype="multipart/form-data" method="post">
                <div class="mb-3">
                    <label for="abreviatura" class="form-label fw-bold">Título Abreviatura:</label>
                ...
                <div class="mb-3">
                    <label for="descripcion" class="form-label fw-bold">Título Descripcion:</label>
                ...
                <div class="mb-3">
                    <label for="nombre_corto" class="form-label fw-bold">Nombre Corto:</label>
                ...
                <div class="mb-3">
                    <label for="perfiles" class="form-label fw-bold">Perfil:</label>
